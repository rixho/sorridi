...
export default function DestinationDetails() {
  ...
  return (
    <>
      ...
      {/* Seksioni i dytë: Teksti në qendër */}
      <Box
        sx={{
          width: "100%",
          maxWidth: "1000px",
          mx: "auto",
          py: { xs: 10, md: 14 }, // ⬆️ më shumë hapësirë sipër dhe poshtë
          px: 3,
          textAlign: "center",
        }}
      >
        ...
        >
          ...
          in complete tranquility. With its pristine landscapes, rich marine
          life, and authentic Mediterranean spirit, Karaburun offers a yacht
          charter experience that feels both exclusive and untouched—perfect for
          those seeking discovery off the beaten path.
        </Typography>
      </Box>
